...
// `void <function name>(void* key, size_t size, void* value, void* usr)`
...
void hashmap_set(hashmap* map, void* key, size_t ksize, void* value);
...
bool hashmap_get_set(hashmap* map, void* key, size_t ksize, void** out_in);
...
void hashmap_set_free(hashmap* map, void* key, size_t ksize, void* value, hashmap_callback c, void* usr);

bool hashmap_get(hashmap* map, void* key, size_t ksize, void** out_val);
